<p align="center">
  ...
  <p align="center"><i>Destrave um uso pragmático e observável do Padrão de Resultado e da programação orientada ao Railsway.</i></p>
  <p align="center">
...
É um monad de resultado de propósito e uso geral que permite criar objetos representando um sucesso (BCDD::Result::Success) ou uma falha (BCDD::Result::Failure).

**Qual problema isso tenta resolver?**

Permite representar consistentemente o conceito de sucesso e fracasso em toda a sua base de código.

Além disso, esta abstração expõe diversas funcionalidades que serão úteis para fazer com que o fluxo da aplicação reaja de forma limpa e segura ao resultado representado por estes objetos.

Faça uso disso para habilitar o padrão [Railway Oriented Programming](https://fsharpforfunandprofit.com/rop/) (super poderes) dentro do seu código.

- [Versões suportadas do Ruby](#supported-ruby)
- [Instalação](#installation)
- [Utilização](#usage)
    - [`BCDD::Result` *versus* `Result`](#bcddresult-versus-result)
- [Referência](#reference)
  - [Métodos básicos](#basic-methods)
    - [Checagem de tipo com `result.is?` ou `method missing`](#checking-types-with-resultis-or-method-missing)
    - [Checagem de tipo com `result.success?` ou `result.failure?`](#checking-types-with-resultsuccess-or-resultfailure)
  ...
  - [Programação orientada ao Railway](#railway-oriented-programming)
    - [`result.and_then`](#resultand_then)
    - [`BCDD::Result.mixin`](#bcddresultmixin)
      - [Examplo de classe (Instance Methods)](#class-example-instance-methods)
      - [Examplo de módulo (Singleton Methods)](#module-example-singleton-methods)
      - [Requerimentos Importantes](#important-requirement)
      - [Injeção de dependência (Dependency Injection)](#dependency-injection)
